# python saveModels.py taskName n1 n2 n3 ...
#
#   Store models in a local folder by invoke the "tasks/taskName.py" module.
#   Modules are stored using:
#       huggingface-cli download --local-dir models/modelName
#
...
def saveModel(model_name):
    os.system(f"huggingface-cli download --local-dir models/{model_name} {model_name}")
